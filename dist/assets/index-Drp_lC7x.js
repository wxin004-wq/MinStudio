...
var customHomeSlides = Object.entries(homeSlideModules).sort(([a], [b]) => a.localeCompare(b)).map(([, url]) => url);
...
function HomeLanding({ lang }) {
	...
	(0, import_react.useEffect)(() => {
		if (homeSlides.length < 2) return void 0;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			"aria-hidden": "true",
			children: homeSlides.map((image, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: `home-background-slide${index === slideIndex ? " active" : ""}`,
				style: { backgroundImage: `url(${image})` }
			}, image))
		}), !homeSlides.length && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "project-cover-fallback",
			children: t.fallback
		})]
	});
